...
![](https://winf-hsos.github.io/university-docs/images/flashlight.png) Hier endet die Geschichte von Max und Ida und ihrer Leidenschaft für Schach. Nun setzen wir unsere Reise in die digitale Welt fort und stellen uns die Frage: Wie können Max und Ida mit nichts weiter als einer Taschenlampe ihre Schachzüge kommunizieren?
...
Information existiert nur, wenn wir die Freiheit haben, aus einer Reihe verschiedener Symbole in einer Sequenz zu wählen. Dies mag zunächst abstrakt klingen, aber ein Beispiel verdeutlicht es schnell.

### Symbolvielfalt

Stellt euch vor, unser Alphabet bestünde nur aus dem Buchstaben "A", und zwar ausschließlich in Großbuchstaben. Nehmen wir weiter an, unsere Nachrichten dürften genau zwei Zeichen lang sein. Können wir unter diesen Bedingungen Informationen übermitteln? Die Antwort ist *nein*, denn unsere einzige Nachricht wäre immer "AA". Mit diesen Einschränkungen ist unsere Nachricht wertlos, da sie keine Information trägt.
